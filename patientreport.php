...
?>
    ...
    ?>
        ...
        if($rs['bill_type']  == "Prescription charge")
        {
          ...
          echo " </td><td>&nbsp;Kshs. $rs[bill_amount]</td></tr>";
                      ...
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <tbody>
                          <tr>
                            ...
                            <td>&nbsp;Kshs. <?php echo $billamt; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                              <td width="95">&nbsp;Kshs. <?php echo $taxamt = 5 * ($billamt / 100); ?>
                              </td>
                          </tr>
                           
                      <tr>
                        <th scope="col"><div align="right">Discount &nbsp; </div></th>
                        <td>&nbsp;Kshs. <?php echo $rsbilling_records['discount']; ?></td>
                        </tr>
    ...
    ?>
                  ...
                  ?>
                    &nbsp;Kshs. <?php echo $billamt; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right"></div></th>
                            <td width="413">&nbsp;</td>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                            <td width="413">&nbsp;Kshs. <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
                          </tr>
                      ...
                      <tr>
                        ...
                        <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
                        <td>&nbsp;Kshs. <?php echo $grandtotal = ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>Kshs. <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
                        </tr>
                        </tbody>
                      </table>
                      ...
                      ?>
                          ...
                          <?php       
                              ...
                              ?>
                                   ...
                                   <td>&nbsp;Kshs. <?php echo $rspayment['paidamount']; ?></td>
                                   </tr>
                              <?php
                              }
                          ?>
